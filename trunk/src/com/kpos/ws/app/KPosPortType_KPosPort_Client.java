...
public final class KPosPortType_KPosPort_Client {
    ...
    public static void main(String args[]) throws Exception {
        ...
        {
        System.out.println("Invoking fetchUnservedOrders...");
        com.kpos.ws.app.FetchUnservedOrdersType _fetchUnservedOrders_parameters = new com.kpos.ws.app.FetchUnservedOrdersType();
        com.kpos.ws.app.FetchUnservedOrdersResponseType _fetchUnservedOrders__return = port.fetchUnservedOrders(_fetchUnservedOrders_parameters);
        System.out.println("fetchUnservedOrders.result=" + _fetchUnservedOrders__return);


        }
        {
        System.out.println("Invoking saveCompanyProfile...");
        com.kpos.ws.app.SaveCompanyProfileType _saveCompanyProfile_parameters = new com.kpos.ws.app.SaveCompanyProfileType();
        com.kpos.ws.app.SaveCompanyProfileResponseType _saveCompanyProfile__return = port.saveCompanyProfile(_saveCompanyProfile_parameters);
        System.out.println("saveCompanyProfile.result=" + _saveCompanyProfile__return);
        ...
        {
        System.out.println("Invoking fetchSaleSummary...");
        com.kpos.ws.app.FetchSaleSummaryType _fetchSaleSummary_parameters = null;
        com.kpos.ws.app.FetchSaleSummaryResponseType _fetchSaleSummary__return = port.fetchSaleSummary(_fetchSaleSummary_parameters);
        System.out.println("fetchSaleSummary.result=" + _fetchSaleSummary__return);
        ...
        {
        System.out.println("Invoking saveDiscountRate...");
        com.kpos.ws.app.SaveDiscountRateType _saveDiscountRate_parameters = new com.kpos.ws.app.SaveDiscountRateType();
        com.kpos.ws.app.SaveDiscountRateResponseType _saveDiscountRate__return = port.saveDiscountRate(_saveDiscountRate_parameters);
        System.out.println("saveDiscountRate.result=" + _saveDiscountRate__return);
        ...
        {
        System.out.println("Invoking getRoleFunctionsHTML...");
        com.kpos.ws.app.GetRoleFunctionsHTMLType _getRoleFunctionsHTML_parameters = new com.kpos.ws.app.GetRoleFunctionsHTMLType();
        com.kpos.ws.app.GetRoleFunctionsHTMLResponseType _getRoleFunctionsHTML__return = port.getRoleFunctionsHTML(_getRoleFunctionsHTML_parameters);
        System.out.println("getRoleFunctionsHTML.result=" + _getRoleFunctionsHTML__return);
        ...
        {
        System.out.println("Invoking fetchOrdersByUser...");
        com.kpos.ws.app.FetchOrdersByUserType _fetchOrdersByUser_parameters = new com.kpos.ws.app.FetchOrdersByUserType();
        com.kpos.ws.app.FetchOrdersByUserResponseType _fetchOrdersByUser__return = port.fetchOrdersByUser(_fetchOrdersByUser_parameters);
        System.out.println("fetchOrdersByUser.result=" + _fetchOrdersByUser__return);


        }
        {
        System.out.println("Invoking deleteDiscountRate...");
        com.kpos.ws.app.DeleteDiscountRateType _deleteDiscountRate_parameters = new com.kpos.ws.app.DeleteDiscountRateType();
        com.kpos.ws.app.DeleteDiscountRateResponseType _deleteDiscountRate__return = port.deleteDiscountRate(_deleteDiscountRate_parameters);
        System.out.println("deleteDiscountRate.result=" + _deleteDiscountRate__return);
        ...
        com.kpos.ws.app.ListRolesType _listRoles_parameters = new com.kpos.ws.app.ListRolesType();
        com.kpos.ws.app.ListRolesResponseType _listRoles__return = port.listRoles(_listRoles_parameters);
        ...
        {
        System.out.println("Invoking listDiscountRates...");
        com.kpos.ws.app.ListDiscountRatesType _listDiscountRates_parameters = new com.kpos.ws.app.ListDiscountRatesType();
        com.kpos.ws.app.ListDiscountRatesResponseType _listDiscountRates__return = port.listDiscountRates(_listDiscountRates_parameters);
        System.out.println("listDiscountRates.result=" + _listDiscountRates__return);


        }
        {
        System.out.println("Invoking fetchOrderByNumber...");
        com.kpos.ws.app.FetchOrderByNumberType _fetchOrderByNumber_parameters = new com.kpos.ws.app.FetchOrderByNumberType();
        com.kpos.ws.app.FetchOrderByNumberResponseType _fetchOrderByNumber__return = port.fetchOrderByNumber(_fetchOrderByNumber_parameters);
        System.out.println("fetchOrderByNumber.result=" + _fetchOrderByNumber__return);
        ...
        com.kpos.ws.app.DeleteRoleType _deleteRole_parameters = new com.kpos.ws.app.DeleteRoleType();
        com.kpos.ws.app.DeleteRoleResponseType _deleteRole__return = port.deleteRole(_deleteRole_parameters);
        ...
        {
        System.out.println("Invoking saveRole...");
        com.kpos.ws.app.SaveRoleType _saveRole_parameters = new com.kpos.ws.app.SaveRoleType();
        com.kpos.ws.app.SaveRoleResponseType _saveRole__return = port.saveRole(_saveRole_parameters);
        System.out.println("saveRole.result=" + _saveRole__return);
        ...
        {
        System.out.println("Invoking fetchCompanyProfile...");
        com.kpos.ws.app.FetchCompanyProfileType _fetchCompanyProfile_parameters = new com.kpos.ws.app.FetchCompanyProfileType();
        com.kpos.ws.app.FetchCompanyProfileResponseType _fetchCompanyProfile__return = port.fetchCompanyProfile(_fetchCompanyProfile_parameters);
        System.out.println("fetchCompanyProfile.result=" + _fetchCompanyProfile__return);
