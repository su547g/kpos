...
public interface KPosPortType {
    ...
    @WebResult(name = "ListRatesResponseType", targetNamespace = "http://ws.kpos.com/app", partName = "parameters")
    @WebMethod(operationName = "ListRates", action = "http://ws.kpos.com/ListRates")
    public ListRatesResponseType listRates(
        @WebParam(partName = "parameters", name = "ListRatesType", targetNamespace = "http://ws.kpos.com/app")
        ListRatesType parameters
    );
